...
authorize_url = 'https://login.microsoftonline.com/{}/oauth2/v2.0/authorize'.format(settings.MS_TEAMS_TENANT_ID)
token_url = 'https://login.microsoftonline.com/{}/oauth2/v2.0/token'.format(settings.MS_TEAMS_TENANT_ID)
...
def get_sign_in_url(request):
    aad_auth = OAuth2Session(settings.MS_TEAMS_APP_ID,
